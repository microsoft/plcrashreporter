...
struct  Plcrash__CrashReport__SystemInfo
{
  ...
  char *os_build;
  /*
   * Device Battery Level (eg, 85) 
   */
  protobuf_c_boolean has_battery_level;
  int64_t battery_level;
  /*
   * Free disk space in bytes (eg, 227573678080) 
   */
  protobuf_c_boolean has_free_disk_space;
  int64_t free_disk_space;
  /*
   * Free memory in bytes (eg, 227573678080) 
   */
  protobuf_c_boolean has_free_memory;
  int64_t free_memory;
};
#define PLCRASH__CRASH_REPORT__SYSTEM_INFO__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&plcrash__crash_report__system_info__descriptor) \
    , 0, PLCRASH__CRASH_REPORT__SYSTEM_INFO__OPERATING_SYSTEM__OS_UNKNOWN, NULL, PLCRASH__ARCHITECTURE__ARCHITECTURE_UNKNOWN, 0, NULL, 0, 0, 0, 0, 0, 0 }
